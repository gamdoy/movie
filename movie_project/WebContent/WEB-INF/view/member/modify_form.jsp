...
<form action="<%=request.getContextPath() %>/member/modifyMemberInfo.do" id="modifyForm" 
	...
	<table style="width:500px">
		...
		<tr>
			<td>생년월일</td>
			<td>
				<input type="text" name="memBirthDate" id="memBirthDate" value="${sessionScope.login_info.memBirthDate }" readonly="readonly" onClick="datePicker(event,'memBirthDate')" onClick="datePicker(event,'memBirthDate')">
			</td>
		</tr>		
		<tr>
			<td>이메일</td>
			<td>
				<input type="text" id="memEmail" name="memEmail" value="${sessionScope.login_info.memEmail }"><span id="emailMessageLayer"></span> <span class="errorMessage"><form:errors path="member.email"/></span>
			</td>
		</tr>
		<tr>
			<td>상세주소</td>
			<td>
				<input type="text" size="7" id="zipcode" name="zipcode" value="${sessionScope.login_info.zipNo }" readonly="readonly">   <input type="text" id="address2" size="25"name="address2" value="${sessionScope.login_info.zipAddress}" readonly="readonly">  <input type="button" id="address" name="address" value="우편번호검색"><br>
				<input type="text" size="30" id="memAddressDetail" name="memAddressDetail" value="${sessionScope.login_info.memAddressDetail }">
			</td>
		</tr>
		<tr>
			<td>연락처</td>
