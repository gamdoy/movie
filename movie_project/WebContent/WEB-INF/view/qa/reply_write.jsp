...
<form method="post" action="<%=request.getContextPath()%>/qa/login/register_reply.do" enctype="multipart/form-data" >
	...
	<tr height="1" bgcolor="#82B5DF"><td colspan="4"></td></tr>
		...
		<tr>
			...
			<td><input type="text" id="name" name="name" size="30" value="${sessionScope.login_info.memId }" disabled="disabled"></td>
