...
ALTER TABLE CASTACTOR
	DROP
		CONSTRAINT FK_MOVIE_TO_CASTACTOR
		CASCADE;

ALTER TABLE CASTACTOR
	DROP
		CONSTRAINT FK_ACTOR_TO_CASTACTOR
		CASCADE;
...
COMMENT ON COLUMN ACTOR.ACT_NO IS '배우번호';
...
COMMENT ON COLUMN DIRECTOR.DIR_NO IS '감독번호';
...
COMMENT ON COLUMN PRODUCTION.PRO_NO IS '제작사번호';
...
ispatcherServlet.LOCALE_RESOLVER
...
/* 출연배우 */
CREATE TABLE CASTACTOR (
	CA_NO NUMBER NOT NULL, /* 출연배우번호 */
	MOV_NO NUMBER NOT NULL, /* 영화번호 */
	ACT_NO NUMBER NOT NULL /* 배우번호 */
);

COMMENT ON TABLE CASTACTOR IS '출연배우';

COMMENT ON COLUMN CASTACTOR.CA_NO IS '출연배우번호';

COMMENT ON COLUMN CASTACTOR.MOV_NO IS '영화번호';

COMMENT ON COLUMN CASTACTOR.ACT_NO IS '배우번호';
